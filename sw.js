const CACHE_NAME = 'york-route-v32';
const APP_FILES = [
  './','./index.html','./uber.css','./features.css','./project-hub.css','./firebase-config.js','./sync-lite.js','./voice-notes.js','./project-hub.js','./menu-pages.js','./ios-scroll-fix.js','./app.js','./businesses.js','./manifest.webmanifest','./icon.svg'
];
